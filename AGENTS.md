...
state/               runtime records and signals; gitignored
  ...
  .claude-autoarm.lock .claude-autoarm-epoch .claude-autoarm-failure-notified .claude-autoarm-failure-alarmed .turnend-claude-blocks .turnend-claude-blocks.lock .turnend-claude-hard-cap   Claude Stop auto-arm single-flight, epoch, failure-episode, attended-alarm, guard-budget, budget-lock, and per-session hard-cap records; never touch
