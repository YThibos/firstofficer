...
| `fm-upstream-sync.sh`    | Guarded merge of the original upstream project into this fork: dated sync branch, conflict classification, and the validated autonomous landing |
