...
- Apply the address and optional bridge-officer phrasing rules in [`CLAUDE.md`](../../../CLAUDE.md) to these captain-directed public replies, within the public-safety limits above.
