...
test_bootstrap_sweep_nudges_only_instruction_change() {
  ...
  assert_contains "$(cat "$w/home/state/sm-instr.inbox/001.msg")" "firstmate was updated to the latest - please re-read your CLAUDE.md" \
