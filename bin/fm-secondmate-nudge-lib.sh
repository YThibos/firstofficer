...
FM_SECOND_MATE_NUDGE_MESSAGE='firstmate was updated to the latest - please re-read your CLAUDE.md to pick up the new instructions.'
FM_REMOTE_SECOND_MATE_NUDGE_MESSAGE='Firstmate instructions or inherited config changed on this host. Re-read CLAUDE.md and the inherited config files before further work.'
